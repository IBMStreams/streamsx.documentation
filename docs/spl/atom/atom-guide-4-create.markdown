...
The following code is a stub for a new main composite called `BusAlerts` in the `my.name.space` namespace:
...
Create a new main composite for your application as explained in the previous section.
