...
To get started with the Python Application API, you'll use the example of reading data from a temperature sensor and printing the output to the screen.  The application runs as a job in your Streaming Analytics instance.
...
## 2.4 Creating a topology object
...
## 2.8 Submitting the job to the Streaming Analytics service
...
## 2.8.1 Viewing the streaming data
