...
For full reference information, see the [documentation for the Python Application API](http://ibmstreams.github.io/streamsx.topology/doc/pythondoc/index.html).
